...
void AP_Motors6DOF::setup_motors(motor_frame_class frame_class, motor_frame_type frame_type)
{
    ...
    case SUB_FRAME_CUSTOM:
        _frame_class_string = "NOMAP";
        add_motor_raw_6dof(AP_MOTORS_MOT_1,     0,           1.0f,              0,              0,              0,              0,          1);
        add_motor_raw_6dof(AP_MOTORS_MOT_2,  1.0f,              0,              0,              0,              0,              0,          2);
        ...
        add_motor_raw_6dof(AP_MOTORS_MOT_6,     0,              0,              0,              0,              0,           1.0f,          6);
        break;
